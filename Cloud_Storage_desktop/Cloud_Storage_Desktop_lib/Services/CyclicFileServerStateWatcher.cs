...
{
    public class CyclicFileServerStateWatcher : IServerFilesStateWatcher
    {
        IServerConnection _connection;
        private static System.Timers.Timer _timer;

        public CyclicFileServerStateWatcher(IServerConnection serverConnection)
        {
        ...
        void TimerCallback(object? state, ElapsedEventArgs args)
        {
            this.RefreshList();
        }
